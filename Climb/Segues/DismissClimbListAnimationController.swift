//
//  DismissClimbListAnimationController.swift
//  Climb
//
...
class DismissClimbListAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
    
    let interactionController: DismissClimbListTransition?
    
    init(interactionController: DismissClimbListTransition) {
